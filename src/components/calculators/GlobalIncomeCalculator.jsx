    ...
    <div>
      ...
      {r && (
        <div className="result-section" ref={resultRef}>
          ...
          <InfoGuide title="📝 5월 종합소득세, 최대한 아끼는 방법">
            <h4>1. 단순경비율 vs 장부 기장 — 어떤 게 유리?</h4>
            <p>수입이 많을수록 단순경비율보다 실제 경비(장부기장)가 유리합니다. <strong>간편장부</strong>는 무료 홈택스 작성 가능하고, 기장세액공제(20%)도 받을 수 있습니다. 실제 경비가 단순경비율보다 높다면 장부를 꼭 쓰세요.</p>
            <h4>2. 사업용 신용카드를 홈택스에 등록하세요</h4>
            <p>사업 관련 지출을 사업용 신용카드로 결제하고 홈택스에 등록하면 <strong>매입세액공제와 경비 자동 집계</strong>가 가능합니다. 한 번 설정하면 연말에 매우 편리합니다.</p>
            <h4>3. 노란우산공제로 소득공제 최대화</h4>
            <p>개인사업자·프리랜서는 <strong>노란우산공제</strong>를 통해 연간 최대 500만원 소득공제가 가능합니다. 소득이 높을수록 절세 효과가 크고, 폐업 시 목돈도 받을 수 있어 사회보험 역할도 합니다.</p>
          </InfoGuide>
        </div>
      )}
    </div>
