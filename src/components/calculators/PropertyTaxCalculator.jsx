    ...
    <div>
      ...
      {r && (
        <div className="result-section" ref={resultRef}>
          ...
          <InfoGuide title="🏛️ 부동산 세금, 꼭 알아야 할 핵심">
            <h4>1. 1주택자 양도소득세 비과세 요건</h4>
            <p>1가구 1주택은 <strong>2년 이상 보유</strong>(조정대상지역은 2년 거주도 필요)하면 최대 12억 이하 양도차익에 대해 비과세입니다. 12억 초과분에 대해서만 과세됩니다.</p>
            <h4>2. 취득세 다주택자 중과 (2024년 기준)</h4>
            <p>조정대상지역에서 2번째 주택을 취득하면 취득세율이 <strong>8%</strong>, 3주택 이상은 <strong>12%</strong>로 급등합니다. 비조정대상지역은 완화 적용됩니다.</p>
            <h4>3. 결과는 근사치, 세무사 상담 필수</h4>
            <p>이 계산기는 표준 공제와 기본세율만 적용한 <strong>참고용 시뮬레이션</strong>입니다. 실제 세금은 1세대 1주택 비과세 여부, 장기보유특별공제 상세 조건, 임대사업자 여부 등 개인 사정에 따라 크게 달라집니다. 세무사 상담을 강력히 권장합니다.</p>
          </InfoGuide>
        </div>
      )}
    </div>
